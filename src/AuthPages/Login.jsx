...
const Login = () => {
  return (
    ...
    <div className='w-full bg-black py-32 px-32'>
      <div className='bg-white/85 grid grid-cols-2 p-6 rounded-2xl'>
      <div className='flex flex-col items-start justify-end box rounded-2xl p-12'>
<div className='text-white flex flex-col gap-2 '>
  ...
  <h2 className='font-heading font-bold text-5xl'>Lorem ipsum dolor sit amet Lorem, ipsum dolor.</h2>
      ...
      <div className=' max-w-xl flex flex-col  font-body'>
        {/* heading */}
<div className='flex flex-col gap-3 '>
  <h2 className='font-semibold text-3xl font-body capitalize'>Start your <span className='italic text-transparent bg-clip-text  bg-gradient-to-br from-[#728ccd] to-[#364c84] font-[Merienda] '>learning journey</span> today</h2>
...
<div className='py-6  w-10/12 '>
  <div className=''>
    ...
    <div className='flex items-center justify-center gap-3 my-4'><span className='flex-1 h-px bg-gray-500'></span><span className='text-sm text-gray-700 capitalize'>or continue with</span><span className='flex-1 h-px bg-gray-500'></span></div>
    </div>
  </div>
</div>
      </div>
